...
def htmlDevolucao(devolucoes, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseDevolucao.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
...
def htmlBaixasDev(baixas, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseBaixaDev.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
