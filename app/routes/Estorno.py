...
@app.route("/lista-estorno", methods=["GET", "POST"])
def listaEstorno():
    ###################################################################################################
...
@app.route("/deletar-baixa/<doc>/<parcela>")
...
@app.route("/deletar-baixa", methods=["GET", "POST"])
def deletarBaixa():
    ###################################################################################################
    # Função que renderiza a tela de listagem de baixas.
...
@app.route("/estornos", methods=["GET", "POST"])
def estornos():
    ###################################################################################################
    # Função que renderiza a tela de listagem de baixas.
