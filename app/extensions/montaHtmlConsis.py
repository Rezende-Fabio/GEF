...
def htmlConsis(titulos, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseConsistencia.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
...
def htmlConsisCli(listaCli, dataDe, dataAte):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseConsistenciaCli.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
