...
def htmlComissao(comissoes, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseComissao.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
...
def htmlComissaoVend(listaVend, dataDe, dataAte):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseComissaoVend.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
