...
@app.route("/atualiza-baseCli-modal")
...
@app.route("/atualiza-baseCli", methods=["GET", "POST"])
def atualizaBaseCli():
    ###################################################################################################
...
@app.route("/api-id-cliente", methods=["GET", "POST"])
def idCliente():
    ###################################################################################################
