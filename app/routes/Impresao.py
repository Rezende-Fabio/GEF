...
############################################################
@app.route("/impressao-comissao", methods=["GET", "POST"])
def impreComissao():
    try:
...
############################################################
@app.route("/impressao-devolucao", methods=["GET", "POST"])
def impreDevolucao():
    try:
        if session["usuario_logado"]:
            dataDe = request.form["dataDe"].replace("-", "")
...
############################################################   
@app.route("/impressao-recebidos", methods=["GET", "POST"])
def impreRecebidos():
    try:
        if session["usuario_logado"]:
            dataDe = request.form["dataDe"].replace("-", "")
...
############################################################
@app.route("/impressao-receber", methods=["GET", "POST"])
def impreReceber():
    try:
        if session["usuario_logado"]:
            cliVend = ""
...
# Rota para a impressão do relatório de comissões
############################################################
@app.route("/impressao-consistencia", methods=["GET", "POST"])
...
# Rota para a impressão do relatório de comissões
############################################################
@app.route("/impressao-observacao", methods=["GET", "POST"])
def impreObservacao():
    try:
        if session["usuario_logado"]:
            dataDe = request.form["dataDe"].replace("-", "")
