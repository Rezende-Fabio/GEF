...
def htmlReceberSegmento(baixas, linhas, seg):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseReceberSeg.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
...
def htmlReceberPeriodo(baixas, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseReceber.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
...
def htmlReceberbVend(baixas, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseReceberCliVend.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
