...
def htmlRecebSegmento(baixas, linhas, seg):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseRecebidosSeg.html", "r+") as html:
        htmlBase = html.read()
    ...
    with open(f"{caminho}/app/templates/impressoes/{nomeHtml}", "a+") as html:
        html.write(htmlBase)
        somaValor = 0
        somaComi = 0
        somaReceb = 0
...
def htmlRecebPeriodo(baixas, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseRecebidos.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
...
def htmlRecebVend(baixas, linhas):
    ...
    with open(f"{caminho}/app/templates/baseImpressao/baseRecebidosCliVend.html", "r+") as html:
        htmlBase = html.read()
        html.flush()
