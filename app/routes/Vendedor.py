...
@app.route("/lista-vendedores", methods=["GET", "POST"])
def listaVendedores():
    ###################################################################################################
...
@app.route("/atualiza-baseVend-modal")
...
@app.route("/atualiza-baseVend", methods=["GET", "POST"])
...
@app.route("/api-id-vendedor", methods=["GET", "POST"])
def idVendedor():
    ###################################################################################################
