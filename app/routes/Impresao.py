    ...
    try:
        ...
        if "vendedor" in request.form.keys():
            ...
            comissoes = DB.session.query(conexao.c_baseCalc, conexao.c_valor, conexao.c_perc, conexao.c_dataBaixa, conexao.c_docRef, conexao.c_numDoc, conexao4.m_parcela.label("parcela"),
                                            conexao4.m_tipoBaixa.label('tipoBaixa'), conexao2.c_razaosocial.label('cliente'), conexao5.s_abrev.label('segmento')).join(conexao4, conexao4.m_id == conexao.c_idBaixa).join(conexao2, conexao2.c_id == conexao4.m_idCliente).join(conexao5, conexao5.s_id == conexao4.m_idSegmento).filter(conexao.c_idVendedor==idVendedor[0],
    ...
    try:
        ...
        if "cliente" in request.form.keys():
            ...
            if segmento == "0":
                ...
                baixas = DB.session.query(conexao.m_dataBaixa, conexao.m_numDoc, conexao.m_parcela, conexao.m_tipoBaixa, conexao.m_deconto, conexao.m_juros,
                                        conexao.m_docRef, conexao3.c_razaosocial.label("cliente"), conexao.m_valor, 
                                        conexao4.v_nome.label("vendedor"), conexao5.t_saldo.label("saldo"), conexao6.c_valor.label("comissao"), conexao2.s_abrev.label("segmento")).join(conexao2, conexao.m_idSegmento==conexao2.s_id).join(conexao3, conexao.m_idCliente==conexao3.c_id).join(conexao4, conexao5.t_idVendedor==conexao4.v_id).filter(conexao.m_dataBaixa>=dataDe, conexao.m_dataBaixa<=dataAte, conexao.m_ativo==1, conexao.m_idSegmento==segmento, conexao.m_numDoc==conexao5.t_numDoc, conexao.m_parcela==conexao5.t_numParcela, conexao.m_id==conexao6.c_idBaixa).order_by(conexao2.s_abrev, conexao.m_dataBaixa).group_by(conexao.m_dataBaixa, conexao.m_numDoc, conexao.m_parcela, 
                                        conexao.m_docRef, conexao3.c_razaosocial, conexao.m_valor, 
                                        conexao4.v_nome, conexao5.t_saldo, conexao5.t_comissao, conexao2.s_abrev)
                                        
                linhas = DB.session.query(conexao.m_dataBaixa, conexao.m_numDoc, conexao.m_parcela, 
                                        conexao.m_docRef, conexao3.c_razaosocial, conexao.m_valor, 
                                        conexao4.v_nome, conexao5.t_saldo, conexao5.t_comissao, conexao2.s_abrev).join(conexao2, conexao.m_idSegmento==conexao2.s_id).join(conexao3, conexao.m_idCliente==conexao3.c_id).join(conexao4, conexao5.t_idVendedor==conexao4.v_id).filter(conexao.m_dataBaixa>=dataDe, conexao.m_dataBaixa<=dataAte, conexao.m_ativo==1, conexao.m_idSegmento==segmento, conexao.m_numDoc==conexao5.t_numDoc, conexao.m_parcela==conexao5.t_numParcela, conexao.m_id==conexao6.c_idBaixa).order_by(conexao2.s_abrev, conexao.m_dataBaixa).group_by(conexao.m_dataBaixa, conexao.m_numDoc, conexao.m_parcela, 
                                        conexao.m_docRef, conexao3.c_razaosocial, conexao.m_valor, 
                                        conexao4.v_nome, conexao5.t_saldo, conexao5.t_comissao, conexao2.s_abrev).count()
                seg = False
    ...
    try:
        ...
        if "cliente" in request.form.keys():
            ...
            baixas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        ...
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte, conexao.t_idCliente==cliente[0]).order_by(conexao.t_dataVenc)
            
            linhas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte, conexao.t_idCliente==cliente[0]).order_by(conexao.t_dataVenc).count()
            ...
            baixas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte, conexao.t_idVendedor==vendedor[0]).order_by(conexao.t_dataVenc)
            
            linhas =  DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte, conexao.t_idVendedor==vendedor[0]).order_by(conexao.t_dataVenc).count()
            ...
            if segmento == "0":
                baixas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento"), conexao4.s_desc.label("descSeg")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte).order_by(conexao4.s_abrev, conexao.t_dataVenc)
            
                linhas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento"), conexao4.s_desc.label("descSeg")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte).order_by(conexao4.s_abrev, conexao.t_dataVenc).count()
                seg = True
                descSegmento = "Todos"
            else:
                baixas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento"), conexao4.s_desc.label("descSegmento")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte, conexao.t_idSegmento==segmento).order_by(conexao4.s_abrev, conexao.t_dataVenc)
            
                linhas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_desc).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte, conexao.t_idSegmento==segmento).order_by(conexao4.s_abrev, conexao.t_dataVenc).count()
                seg = False
            ...
            baixas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_abrev.label("segmento")).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte).order_by(conexao.t_dataVenc)
            
            linhas = DB.session.query(conexao.t_numDoc, conexao.t_numParcela, 
                                        conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), 
                                        conexao3.v_nome.label("vendedor"), conexao.t_saldo, conexao4.s_desc).join(conexao2, conexao.t_idCliente==conexao2.c_id).join(conexao3, conexao.t_idVendedor==conexao3.v_id).join(conexao4, conexao.t_idSegmento==conexao4.s_id).filter(conexao.t_ativo==1, conexao.t_status==1, conexao.t_dataLanc>=dataDe, conexao.t_dataLanc<=dataAte).order_by(conexao.t_dataVenc).count()
...
def impreConsisitencia():
    try:  
        if "dataDeCli" in request.form.keys():
            ...
            .join(conexao4, conexao4.s_id==conexao.t_idSegmento) \
