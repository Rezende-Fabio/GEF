...
@clienteBlue.route("/cliente/<id>", methods=["GET"])
@login_required
def popupViewCli(id):
    ###################################################################################################
    ...
    try:
        ...
        context = {"cliente": cliente} #Dicionário contendo as variáveis para utilizar no template
        return render_template("cliente/corpoModalVisuCli.html", context=context)
...
@clienteBlue.route("/atualiza-baseCli", methods=["POST"])
@login_required
def atualizaBaseCli():
    ###################################################################################################
