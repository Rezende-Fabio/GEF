    ...
    with open(f"{caminho}/app/templates/impressoes/{nomeHtml}", "a+") as html:
        ...
        for j, i in enumerate(listaDoc):
            ...
            baixas = db.session.query(conexao.t_numDoc, conexao.t_numParcela, conexao.t_docRef, conexao.t_dataLanc,
                                          conexao.t_dataVenc, conexao2.c_razaosocial.label("cliente"), conexao.t_valor,
            ...
            html.write(f"""
                       ...
                       <p class="cabec">Numero...... : {i}</p>
                        <P class="cabec">Cliente......... : {baixas[0].cliente}</P> 
                        <p class="cabec">Vendedor... : {baixas[0].vendedor}</p>
