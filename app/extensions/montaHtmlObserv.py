        ...
        for j, i in enumerate(listaId):
            ...
            html.write(f"""
                    <div style="width: 100%; justify-content: center; align-items: center; display: flex; margin-top: 1.5rem;">
                        <h7><strong>Observacoes da Baixa</strong></h7>
                    </div>
                    <p class="cabec">Numero...... : {baixas.m_numDoc}</p>
                    <p class="cabec">Referencia.. : {baixas.m_docRef}</p>
                    ...
                    <span>______________________________ OBSERVACAO ______________________________</span><br>
